...
$classes = Flux::classes()
    ...
    ->add(match ($accent) {
        ...
        false => [
            'hover:text-zinc-800 dark:hover:text-white',
            'data-current:text-white dark:data-current:text-white hover:bg-white dark:hover:bg-white/10',
            'data-current:after:bg-white dark:data-current:after:bg-white',
        ],
    })
    ;
@endphp
